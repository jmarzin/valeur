...
Fonctionnalité: Consultation des projets
  ...
  Scénario: s'il n'y a pas de projet
    ...
    Alors je ne vois pas Id,Code,Nom,Ministère,Public,Etat,Date début,Montant,Délai,Delta coût,Delta délai,Quotation
 
  Scénario: Consulter la liste des projets
    Etant donné un projet complet dans la base
    Quand je suis sur la page /projets
    Alors je vois Id,Code,Nom,Ministère,Public,Etat,Date début,Montant,Délai,Delta coût,Delta délai,Quotation

  Scénario: Consulter les données des projets
    Etant donné un projet complet dans la base
    Quand je suis sur la page /projets
    Alors je vois ses Id,Code,Nom,Ministère,Public,Etat,Date début,Montant,Délai,Delta coût,Delta délai,Quotation
